	...
	public static void main(String[] args) {
		...
		**No need to write Selenium script - Just find these elements in the DOM using only XPaths
		...
		9. Select the first resulting lead
			driver.findElement(By.xpath("(//*[@class='x-grid3-cell-inner x-grid3-col-partyId']//descendant::a)[1]")).click();
		10. Click the second img icon
		driver.findElement(By.xpath("//*[@class='x-grid3-cell-inner x-grid3-col-partyId']//descendant::a)[2]")).click();
